...
public class LayoutSlidingTab extends HorizontalScrollView {
    ...
    private final LayoutSlidingTabStrip mTabStrip;
    ...
    public LayoutSlidingTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new LayoutSlidingTabStrip(context);
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link LayoutSlidingTab} you are
