...
public class GetGCM extends AsyncTask<Void, Void, String> {
    ...
    public GetGCM(Context context, Person userLogin, List<Person> friends, SharedPreferences sharedPreferences){
...
public void onPostExecute(String idMSG) {
        ...
        LoadAllInformation load = new LoadAllInformation(context);
