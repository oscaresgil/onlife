...
import com.example.henzer.socialize.GCMClient.GcmAndroidId;


public class MainActivity extends ActionBarActivity {
    private GcmAndroidId androidId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * When the user logs in with fb or other social app; in our app, this will run..
         */
       /*Button b = (Button) findViewById(R.id.<Nombre>);
       b.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               androidId = new GcmAndroidId();
               androidId.getRegId();
           }
       });*/
